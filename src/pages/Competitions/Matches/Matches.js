...
import "./Matches.css";
import { Typography, Paper, IconButton, InputBase, Box, FormControl, MenuItem, Select } from '@mui/material';
        ...
        <Col lg={8} >
            <div className='layout-cols'>
                ...
                <div style={containerStyle}>
                    ...
                    <Row xs={12} className="g-4">
                        <CustomTable matches={competition?.matches} searchInput={searchInput} selected={selected} />
                    </Row>
                </div>
                </MainContent>
            </div>
